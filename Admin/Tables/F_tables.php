...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="../A_index.html">Admin Dashboard</a>
            <!-- Sidebar Toggle-->
                    ...
                    <div class="container-fluid px-4">
                        ...
                        <ol class="breadcrumb mb-4">
							...
							<table border=3 width=65%>
								...
								<div class="form" id="createFaculty">
								<form method="post">
								
									<br>
									<label for="Fac_id"><b>Faculty ID</b></label>
									<input type="text" name="Fac_id">

									<label for="Fac_name"><b>Name</b></label>
									<input type="text" name="Fac_name">

									<label for="Fac_DOJ"><b>Date of Joining</b></label>
									<input type="date" name="Fac_DOJ">
									...
									<input type="submit" name="create_faculty" value="Create Faculty"/>
									<?php
