...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
        <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
            <!-- Navbar Brand-->
            <a class="navbar-brand ps-3" href="../A_index.php">Admin Page</a>
            <!-- Sidebar Toggle-->
                        ...
                        <ol class="breadcrumb mb-4">
							...
							<table border=3 width=65%>
										...
										?>
												...
												<td> <?php echo "".$row_product["Stu_year_of_employment"]; ?></td>
								...
								<div class="form" id="createStudent">
								<form method="post">
									...
									<label for="Stu_year_of_employment"><b>Year of Enrollment</b></label>
									<input type="text" name="Stu_year_of_employment">
									
									<label for="Stu_major"><b>Major</b></label>
									<input type="text" name="Stu_major">

									<label for="CGPA"><b>CGPA</b></label>
									<input type="text" name="CGPA">

									<label for="year_of_graduation"><b>Year of Graduation</b></label>
									<input type="text" name="year_of_graduation">
									...
									if ($_SERVER["REQUEST_METHOD"] == "POST" && isset($_POST["create_student"]))
									{
										...
										$Stu_year_of_employment = $_POST["Stu_year_of_employment"];
										$Stu_major = $_POST["Stu_major"];
										$CGPA = $_POST["CGPA"];
										$year_of_graduation = $_POST["year_of_graduation"];
										
										$sql = "INSERT INTO student_tab (Stu_id, Stu_name, Stu_year_of_employment, Stu_major, CGPA, year_of_graduation) VALUES ($Stu_id, '$Stu_name', $Stu_year_of_employment, '$Stu_major', '$CGPA', $year_of_graduation)";									}
										$connect->query($sql);
									?>
								</form>	
								</div>
